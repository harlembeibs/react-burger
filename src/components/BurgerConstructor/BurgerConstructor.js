...
const BurgerConstructorItems = ({ data }) => {
  return (
    <div className={burgerConstructorStyles.BurgerConstructorItemsContainer}>
      {
        data.map((item, index) => {
          return(
            <div className={burgerConstructorStyles.ingredientsContainer} key={index}>
            <DragIcon key={index + 1} />
            <ConstructorElement
              isLocked={undefined}
              type={undefined} 
              text={item.name}
...
const bun = Array.from(data.filter((item) => item.type === "bun"));
  ...
  render() {
    return (
      <section className={burgerConstructorStyles.container}>
        ...
        <div className={burgerConstructorStyles.scrollBarContainer}>
          <Scrollbars renderThumbVertical={props => <div {...props} className={burgerConstructorStyles.thumbVertical} />}>
            <article className={burgerConstructorStyles.itemsContainer}>
              <BurgerConstructorItems data={ingredients} />
            </article>
          </Scrollbars>
        </div>
        {
